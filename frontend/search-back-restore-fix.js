...
//
// The search results are kept outside app.js and restored through
// the existing showSearch/renderSearchResults functions.
...
(function installSearchBackRestoreFix() {
  ...
  window.performSearch = async function performSearchWithRestoreCache(...args) {
    window.__GOLZAR_SEARCH_FILTERS__ = getSearchFilters();
